...
public class Upload {
    ...
    public  Upload(){};
    public  Upload(String serverURL, String local, String userID, String userpassword) {   
...
//getFileList(client, File.separator, files, directories);
...
System.out.println("File search Error!2");
//return;
}
///************업로드***************
// 로컬 디렉토리 설정
...
getUploadList(localroot, files, directories);
// 디렉토리 생성
for (String directory : directories) {
